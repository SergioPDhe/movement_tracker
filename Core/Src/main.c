...
/* Definitions for SendBLEData */
osThreadId_t SendBLEDataHandle;
const osThreadAttr_t SendBLEData_attributes = {
  .name = "SendBLEData",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_StartSendBLEData */
/**
* @brief Function implementing the SendBLEData thread.
* @param argument: Not used
* @retval None
*/
...
void StartSendBLEData(void *argument)
{
  ...
  osThreadTerminate(NULL);
  /* USER CODE END StartSendBLEData */
}
